...
configure_apparmor:
	...
	else echo "configure_apparmor.sh has already been executed. Skipping..."; fi
...
configure_system_hardening:
	...
	else echo "configure_system_hardening.sh has already been executed. Skipping..."; fi
...
configure_unattended_upgrades:
	...
	else echo "configure_unattended_upgrades.sh has already been executed. Skipping..."; fi
...
configure_compiler_restrictions:
	...
	else echo "configure_compiler_restrictions.sh has already been executed. Skipping..."; fi
...
disable_root_ssh:
	...
	else echo "disable_root_ssh.sh has already been executed. Skipping..."; fi
...
disable_unnecessary_services:
	...
	else echo "disable_unnecessary_services.sh has already been executed. Skipping..."; fi
...
install_clamav:
	...
	else echo "install_clamav.sh has already been executed. Skipping..."; fi
...
install_debsecan:
	...
	else echo "install_debsecan.sh has already been executed. Skipping..."; fi
...
install_logwatch:
	...
	else echo "install_logwatch.sh has already been executed. Skipping..."; fi
...
install_lynis_audit:
	...
	else echo "install_lynis_audit.sh has already been executed. Skipping..."; fi
...
install_net_tools:
	...
	else echo "install_net_tools.sh has already been executed. Skipping..."; fi
...
secure_log_directories:
	...
	else echo "secure_log_directories.sh has already been executed. Skipping..."; fi
...
setup_cron_jobs:
	...
	else echo "setup_cron_jobs.sh has already been executed. Skipping..."; fi
